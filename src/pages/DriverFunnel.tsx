        ...
        <div className="container-custom relative z-10 pt-20 pb-8">
          <div className="max-w-3xl">
            <div className="max-w-full overflow-hidden">
              ...
              {/* Stat Pills */}
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="flex flex-wrap gap-3 mb-5">
                {perks.map((p) => (
              ...
              {/* CTAs */}
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="flex flex-row gap-3 items-center">
