...
const perks = [
  { icon: DollarSign, label: "68 CPM", sub: "Empty & Loaded" },
...
const DriverFunnel = () => {
  ...
  const schemas = useMemo(() => [
    ...
    getJobPostingSchema({
      ...
      description: "68 CPM empty & loaded + 2 CPM fuel bonus. Drop & hook dry van. New Volvos & Freightliners. $2,200–$2,400/week potential.",
  ...
  return (
    <Layout onApplyClick={() => setQualifyOpen(true)}>
      <SEOHead
        ...
        keywords="OTR driver jobs, CDL-A jobs, drop and hook trucking, company driver 68 CPM, dry van jobs, trucking jobs Chicago"
            ...
            <div className="max-w-2xl flex-1">
              <div className="text-left max-w-full">
                ...
                <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="text-muted-foreground text-xs lg:text-sm max-w-xl mb-2 lg:mb-4">
                  <span className="text-foreground font-semibold">68 CPM Empty & Loaded + 2 CPM Fuel Bonus</span> starting Day 1. <span className="text-accent font-semibold">70–80% Drop &amp; Hook</span> — no-touch freight, less waiting, more miles. New trucks, customer lanes, dry van only.
                </motion.p>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-4 gap-2 md:gap-4 text-center">
            {[
              ...
              { value: "68 CPM", label: "Empty & Loaded" },
