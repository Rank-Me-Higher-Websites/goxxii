...
const CompanyDrivers = () => {
  const schemas = useMemo(() => [
    ...
    getJobPostingSchema({
      ...
      description: "Join XXII Century as a company driver. Starting at 63 CPM with automatic raises. Full benefits including health, dental, vision, 401(k). Modern equipment, weekly pay.",
