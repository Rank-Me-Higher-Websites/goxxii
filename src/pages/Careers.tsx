        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="flex flex-wrap gap-6 justify-center text-sm">
              ...
              <a href="mailto:james@goxxii.com" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <Mail className="w-4 h-4" /> james@goxxii.com
              </a>
            </div>
          </motion.div>
        </div>
