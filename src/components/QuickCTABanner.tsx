        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="heroOutline" size="lg" asChild>
              <a href="tel:7735725012" className="inline-flex items-center gap-2">
                <Phone className="w-5 h-5" /> 773-572-5012
              </a>
            </Button>
            <a
              href="mailto:hr@goxxii.com"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full font-semibold text-sm bg-[hsl(142,70%,55%)] text-background shadow-[0_0_16px_hsl(142,70%,55%,0.35)] hover:shadow-[0_0_24px_hsl(142,70%,55%,0.5)] hover:bg-[hsl(142,70%,60%)] transition-all duration-300"
            >
              Partner with XXII
            </a>
          </div>
