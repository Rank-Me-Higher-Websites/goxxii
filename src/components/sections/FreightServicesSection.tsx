...
import trucksFleet from "@/assets/driver-truck-selfie.jpg";
...
export const FreightServicesSection = () => {
  ...
  const bottomY = useTransform(scrollYProgress, [0.5, 0.85], [0, maxBottomShift]);
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="hidden lg:block glass rounded-2xl overflow-hidden max-w-md mx-auto">
              <img
                src={trucksFleet}
