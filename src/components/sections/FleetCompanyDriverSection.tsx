        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Our <Link to="/company-drivers" className="text-primary hover:underline">company driver positions</Link> offer the stability and benefits you deserve without the hassles of truck ownership. Starting at $2,300+/week with automatic raises every 75,000 miles, plus performance bonuses that reward your dedication on every run.
            </p>
