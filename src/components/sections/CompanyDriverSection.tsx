      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <div className="text-xl sm:text-2xl font-display font-bold text-gradient">$2,300+</div>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-5">
              Get consistent miles, $2,300+/week starting pay, and full benefits without the overhead of ownership. Own your own truck? Explore our <Link to="/owner-operators" className="text-muted-foreground hover:text-primary underline underline-offset-2">owner operator program</Link>.
            </p>
